        ...
        rootRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    trackingadd1.setText(dataSnapshot.child("add1").getValue().toString());
                    notification("New Notification","Check Parcel Status");
                    trackingadd2.setText(dataSnapshot.child("add2").getValue().toString());
                    //   notification("My first Notification","Notification content2");
                    trackingadd3.setText(dataSnapshot.child("add3").getValue().toString());
                    //  notification("My first Notification","Notification content3");
                    trackingadd4.setText(dataSnapshot.child("add4").getValue().toString());
    ...
    public void onClick(View v) {
        if (v == mapbtnView) {
            if (user1.equals(demo)) {
                ...
                Toast.makeText(StatusLocation.this, "Please Register ", Toast.LENGTH_SHORT).show();
        ...
        else  if (v == btnChangeDeliveryAddress) {
            if (user1.equals(demo)) {
                //closing this activity
                finish();
                //starting login activity
